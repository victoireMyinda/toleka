...
class TransAcademiaDropDownPersRef extends StatefulWidget {
  ...
  _TransAcademiaDropDownPersRefState createState() =>
      _TransAcademiaDropDownPersRefState();
}

class _TransAcademiaDropDownPersRefState
    extends State<TransAcademiaDropDownPersRef> {
  ...
  void initState() {
    ...
    if (widget.value == "universite") {
      ...
      labelForDropdown = "label";
    } else if (widget.value == "personneref") {
      labelForDropdown = "nom_complet";
    } else {
      labelForDropdown = "libele";
    }
  }
              ...
              return DropdownButtonFormField(
                ...
                items: state.field![widget.items]
                  ...
                  return DropdownMenuItem(
                    value: widget.value == "personneref"
                        ? item['id'].toString()
