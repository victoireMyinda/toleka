...
class CardPersonneRef extends StatefulWidget {
  final Map? data;
  const CardPersonneRef({super.key, this.data});

  @override
  State<CardPersonneRef> createState() => _CardPersonneRefState();
}

class _CardPersonneRefState extends State<CardPersonneRef> {
  @override
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        //     return Text(
                        //       "Adresse : ${widget.data!["adresse_complete"]}",
                        //       style: TextStyle(
                        //           fontWeight: FontWeight.w400, fontSize: 11),
                        //     );
                        //   },
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        BlocBuilder<SignupCubit, SignupState>(
                          builder: (context, state) {
                            return Text(
                              "Téléphone : ${widget.data!["telephone"]}",
                              style: TextStyle(
                                  fontWeight: FontWeight.w400, fontSize: 11),
                            );
                          },
                  ...
                  Container(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text("Créé : ${widget.data!["created_at"]}",
                            style: TextStyle(
                                fontWeight: FontWeight.w400, fontSize: 11)),
                      ],
                    ),
